...
// Shows the 10 levels of a pack with stars and best score.
...
function LevelSelector({ pack, progress, onBack, onPickLevel, density = 'comfortable' }) {
  ...
  // sequential within pack: a level is unlocked if it's level 0 OR the previous one has >=1 star
    ...
    <div className="fp-screen" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ opacity: 0.5 }}>/ {possible}</span>
        </div>
      </div>
...
// Single level row — number, name, mini graph hint, stars, best
    ...
    <button onClick={onClick} disabled={!unlocked} style={{
      ...
      <div style={{
        ...
        <span className="fp-mono" style={{
          fontSize: 18, fontWeight: 500, color: 'var(--fp-ink)',
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 4 }}>
        <div style={{
          ...
          <span style={{
            fontSize: 14, fontWeight: 500, color: 'var(--fp-ink)',
          }}>
            {LEVEL_NAMES[index]}
          </span>
      ...
      {/* Trailing — mini graph or chevron */}
      <div style={{
